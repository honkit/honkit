...
GitHons provides different APIs and contexts to plugins. These APIs can vary according to the GitHon version being used, your plugin should specify the `engines.githon` field in `package.json` accordingly.
