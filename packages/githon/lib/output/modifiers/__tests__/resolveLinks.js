...
describe("resolveLinks", () => {
    ...
    describe("Absolute path", () => {
        ...
        test('should resolve path starting by "/" in root directory', () => {
            ...
            return resolveLinks("hello.md", resolveFileBasic, $).then(function () {
                var link = $("a");
        ...
        test('should resolve path starting by "/" in child directory', () => {
            ...
            return resolveLinks("afolder/hello.md", resolveFileBasic, $).then(function () {
                var link = $("a");
                expect(link.attr("href")).toBe("../fakeDir/test/cool.md");
            });
        });
    ...
    describe("Anchor", () => {
        test("should prevent anchors in resolution", () => {
            ...
            return resolveLinks("hello.md", resolveFileCustom, $).then(function () {
                var link = $("a");
    ...
    describe("Custom Resolver", () => {
        ...
        test("should resolve path correctly for absolute path (2)", () => {
            ...
            return resolveLinks("afodler/hello.md", resolveFileCustom, $).then(function () {
                var link = $("a").first();
                expect(link.attr("href")).toBe("../test/cool.html");
            });
        });
