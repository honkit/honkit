...
export default {
    parseBook: parseBook0,
    parseSummary: parseSummary0,
    parseGlossary: parseGlossary0,
    parseReadme: parseReadme0,
    parseConfig: parseConfig0,
    parsePagesList: parsePagesList0,
    parseIgnore: parseIgnore0,
    listAssets: listAssets0,
