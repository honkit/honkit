...
export default {
    insertArticle: insertArticle0,
    moveArticle: moveArticle0,
    moveArticleAfter: moveArticleAfter0,
    removeArticle: removeArticle0,
    unshiftArticle: unshiftArticle0,
    editArticleTitle: editArticleTitle0,
