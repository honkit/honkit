...
export default {
    encodeOutput: encodeOutput0,
    encodeBookWithPage: encodeBookWithPage0,
    encodeOutputWithPage: encodeOutputWithPage0,
    encodeBook: encodeBook0,
    encodeFile: encodeFile0,
