...
describe("sortDependencies", () => {
    test("must load themes after plugins", () => {
        var allPlugins = PluginDependency.listFromArray(["hello", "theme-test", "world"]);
    ...
    test("must keep order of themes", () => {
        var allPlugins = PluginDependency.listFromArray(["theme-test", "theme-test1", "hello", "theme-test2", "world"]);
        var sorted = sortDependencies(allPlugins);
        var names = toNames(sorted);
